...
const SolutionPageMobile: NextPage = () => {
  ...
  return (
    <div className="mt-20 px-4">
      ...
      <div className="solution-groups pl-[26px] pt-[34px] bg-[url(/static/index-line-mobile.svg)] bg-no-repeat mb-10">
        <SolutionItem
          title={t('solution-1-title')}
          brief={t('solution-1-content')}
          imagePosition="left"
          imageUrl="/static/index-solution-1.png"
        ...
        <SolutionItem
          ...
          imagePosition="right"
          imageUrl="/static/index-solution-2.png"
        ...
        <SolutionItem
          ...
          imagePosition="left"
          imageUrl="/static/index-solution-3.png"
        ...
        <SolutionItem
          ...
          imagePosition="right"
          imageUrl="/static/index-solution-4.png"
