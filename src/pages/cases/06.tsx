  ...
  return (
    <>
      ...
      <CaseDetailPage
        ...
        themeColor="#BB3DFF"
        title="某国际一线美妆大品牌"
        brief="该品牌为国际一线美妆品牌，私域主要通过 AI 外呼把数百万手机号迁移到企业微信做产品营销和复购"
        datas={[
          {
            title: '40%',
            subtitle: '自动化激活会员率',
        ...
        features={[
          ...
          },
          {
            ...
            title: '高频应答',
            subtitle:
              'RPA 助力，在用户添加好友后发送多轮欢迎语，包含文字、图片和入群链接',
          },
          {
            icon: '6-3.svg',
            title: '高频触达',
            subtitle:
              'RPA 助力高效触达，进行每天 10 次，近 30 条的营销信息群发',
          },
          {
            icon: '6-4.svg',
            title: '自动应答',
            subtitle:
              'RPA 助力效率应答，可对用户的大部分提问进行自动回复，导购人员仅需对个性提问进行专项回复',
          },
          {
            icon: '6-5.svg',
            title: '用户数据化资产沉淀',
        ...
        achievements={[
          ...
          },
          {
            icon: '02',
            title:
              '数十万小程序用户行为的自动标签化，真正具备了千人千面的营销推送能力',
          },
        ]}
      />
    </>
