        ...
        features={[
          {
            ...
            title: '渠道二维码',
            subtitle:
              '将来自公众号自动回复、公众号菜单栏、小程序不同渠道的用户随机分配给旗下近500个企业微信账号，清晰标注用户来源',
          },
          {
            icon: '20-2.svg',
            title: '无限条数欢迎语',
          ...
          },
          {
            ...
            title: '消息聚合',
            subtitle:
              '将多个账号的消息聚合在一个聊天页面，使得一人可管理10+个账号上的5W+粉丝的消息应答',
          },
        ]}
        achievements={[
          {
            icon: '03',
            title:
              '人效比大规模提升，私域团队人均服务5万客户、150+社群，每日平均面向群聊发送2条直播预告消息',
          },
          {
            icon: '08',
            title:
              '平均首次响应时长缩短至 5min，30s 内应答率达 22.18 %，日均私聊发送消息数达 400+ 条，聊天回复率达 99%',
          },
          {
            icon: '06',
