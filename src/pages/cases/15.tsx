      ...
      <CaseDetailPage
        ...
        features={[
          ...
          },
          {
            icon: '15-5.svg',
            title: '关键词自动应答',
            subtitle: '原来需要大量人力对用户的常规问题进行重复性回答的，借由关键词回复功能，可实现常规问题的自动回复，运营人员仅需对个性提问进行专项回复',
          },
          {
            icon: '15-6.svg',
            title: '无限次群发',
            subtitle:
              '突破企微原有每天 1 次的群发限制，每天进行 3 次以上社群群发私信群发，保证营销信息的高频触达',
          },
        ]}
        achievements={[
          {
            icon: '03',
            title:
              '3 人管理 12 个账号上的 10 万+客户消息应答和营销触达，极大提高了人效比',
          },
          {
            icon: '06',
