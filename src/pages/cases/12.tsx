      ...
      <CaseDetailPage
        ...
        features={[
          ...
          },
          {
            icon: '12-2.svg',
            title: '高频应答',
            subtitle: 'RPA 助力应答效率，自动发送多条内容和入群邀请',
          },
          {
            icon: '12-3.svg',
            title: '定时群发',
        ...
        achievements={[
          {
            icon: '07',
            title:
              '通过AI外呼将客户迁移到企业微信中，月均涨粉 5W+',
          },
          {
            icon: '03',
            title: '已回复聊天占比达100%，日均聊天数达1300+条，平均首次响应时长仅为2s，首次响应30s内应答率可达100%，客服处理效率得到显著提升',
          },
          {
            icon: '02',
            title: '实现集团对全国20个地区、数百个云导购账号的统一管理',
          },
        ]}
      />
    </>
