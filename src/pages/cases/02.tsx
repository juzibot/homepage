    ...
    <>
      ...
      <CaseDetailPage
        ...
        steps={[
          ...
          '用户回复我要进群后，立刻收到入群链接',
          '用户加入福利群后立刻收到被@ 的欢迎语告知社群活动安排。在群内每天会收到2--3次的活动介绍，类型分为三类：群内答题抽奖、跳一跳小游戏排名兑奖、以及邀请好友助力兑奖。每周三和周五还会看到额外的福利和红包雨活动',
        ...
        features={[
          ...
          },
          {
            ...
            title: '无限次群发',
            subtitle:
              '突破企微原有每天1次的群发限制，每天进行2-3次社群群发和私信群发，保证营销信息的高频触达',
          },
          {
            icon: 'pink-1.svg',
            title: '自动化邀请入群',
            subtitle:
              '原来需要大量人工手动邀请入群的用户，可以根据消息关键词自动完成拉群动作，极大节省人力、提高入群率',
          },
          {
            icon: 'purple-2.svg',
            title: '关键词自动应答',
        ...
        achievements={[
          ...
          {
            icon: '02',
            title: '2 人管理账号下 3万余个用户的消息，极大地提高了人效比',
          },
        ]}
      />
    </>
